...
public class SimpleLongColumn<Table, JavaType, Binder extends SimpleColumnBinder<JavaType, @Nullable Long>, IsIndexed extends AbstractJavaColumn.IndexedFlag>
		implements AbstractJavaColumn<Table, JavaType, IsIndexed, AbstractJavaColumn.SingleBinder>
{
	private final Binder binder;
	private final String sqlColumnName;

	public SimpleLongColumn(Binder binder, String sqlColumnName) {
		this.binder = binder;
	...
	public JavaType fromSql(@Nullable Long sqlValue) {
