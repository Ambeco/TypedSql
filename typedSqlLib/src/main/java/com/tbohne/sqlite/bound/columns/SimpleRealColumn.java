...
public class SimpleRealColumn<Table, JavaType, Binder extends SimpleColumnBinder<JavaType, @Nullable Double>, IsIndexed extends AbstractJavaColumn.IndexedFlag>
		implements AbstractJavaColumn<Table, JavaType, IsIndexed, AbstractJavaColumn.SingleBinder>
{
	private final Binder binder;
	private final String sqlColumnName;

	public SimpleRealColumn(Binder binder, String sqlColumnName) {
		this.binder = binder;
	...
	public JavaType fromSql(@Nullable Double sqlValue) {
