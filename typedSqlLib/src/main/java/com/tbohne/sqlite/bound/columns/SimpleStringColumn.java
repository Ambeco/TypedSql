...
public class SimpleStringColumn<Table, JavaType, Binder extends SimpleColumnBinder<JavaType, @Nullable String>, IsIndexed extends AbstractJavaColumn.IndexedFlag>
		implements AbstractJavaColumn<Table, JavaType, IsIndexed, AbstractJavaColumn.SingleBinder>
{
	private final Binder binder;
	private final String sqlColumnName;

	public SimpleStringColumn(Binder binder, String sqlColumnName) {
		this.binder = binder;
	...
	public JavaType fromSql(@Nullable String sqlValue) {
