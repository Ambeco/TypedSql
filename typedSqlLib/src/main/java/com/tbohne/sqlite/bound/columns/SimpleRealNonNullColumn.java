...
public class SimpleRealNonNullColumn<Table, JavaType, Binder extends SimpleColumnBinder<JavaType, Double>, IsIndexed extends AbstractJavaColumn.IndexedFlag>
		implements AbstractJavaColumn<Table, JavaType, IsIndexed, AbstractJavaColumn.SingleBinder>
{
	private final Binder binder;
	private final String sqlColumnName;

	public SimpleRealNonNullColumn(Binder binder, String sqlColumnName) {
		this.binder = binder;
	...
	public JavaType fromSql(Double sqlValue) {
