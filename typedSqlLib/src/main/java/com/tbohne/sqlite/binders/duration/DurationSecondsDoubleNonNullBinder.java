...
public class DurationSecondsDoubleNonNullBinder
		implements SimpleColumnBinder<Duration, Double>
{
	@Override
	public Duration fromSql(Double columnValue) {
	...
	@Override
	public Double toSql(Duration javaValue) {
