...
public class DurationSecondsLongBinder
		implements SimpleColumnBinder<@Nullable Duration, @Nullable Long>
{
	@Override
	public @Nullable Duration fromSql(@Nullable Long columnValue) {
		if (columnValue == null) {
			return null;
		}
		return Duration.ofSeconds(columnValue);
	}

	@Override
	public @Nullable Long toSql(@Nullable Duration javaValue) {
		if (javaValue == null) {
			return null;
		}
		return javaValue.toSeconds();
	}
}
