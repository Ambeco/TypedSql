 ...
 **/
public class Instant8601Binder
		implements SimpleColumnBinder<@Nullable Instant, @Nullable String>
{
	@Override
	public @Nullable Instant fromSql(@Nullable String columnValue) {
		if (columnValue == null) {
			return null;
		}
	...
	@Override
	public @Nullable String toSql(@Nullable Instant javaValue) {
		if (javaValue == null) {
			return null;
		}
