...
public class Duration8601NonNullBinder
		implements SimpleColumnBinder<Duration, String>
{
	@Override
	public Duration fromSql(String columnValue) throws DateTimeParseException {
